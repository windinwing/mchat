...
> **相关**：[短信通知（Workflow 出站）](notifications.zh.md) · [Workflow orchestrator（英文）](workflow-orchestrator.en.md)
...
`docs/workflow-orchestrator.en.md` 中「尚未接入站内消息中心」指本方案尚未落地，而非要做独立消息中心。
